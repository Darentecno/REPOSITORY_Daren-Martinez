...
public class SaludoServiceImpl implements ISaludoService {
  ...
  //  private  final EmployeeFeingProvider employeeFeingProvider;
    ...
    public SaludoServiceImpl(SaludosPropertiesConfig saludosPropertiesConfig, String saludo) {
 ...
 //   }
    ...
    @Override
    public ResponseEntity getSaludDosParamName(String nomb) {
        String saludoCompleto = saludosPropertiesConfig.getSaludoMap(SaludosPropertiesConfig.BUENAS_NOCHES) + " " + nomb;
        return ResponseEntity.ok(saludoCompleto);
    }
